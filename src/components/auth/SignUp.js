...
class SignUp extends Component {
  constructor(props) {
    super(props);
    this.googleSignUpFunction = this.googleSignUpFunction.bind(this);
    this.facebookSignUpFunction = this.facebookSignUpFunction.bind(this);
                  ...
                  {/* <div className="text-center auto row">
                    ...
                    >
                      ...
                      />
                        ...
                        <div className="col-md-10">Sign Up</div>
                      </div>
                    </Button>
                  </div> */}
                  <hr />
                  ...
                  <div className="text-center auto row">
                    ...
                    <Button className="col-md-8">
                      <div className="row">
                        ...
                        <div className="col-md-10">Sign Up With Facebook</div>
                      </div>
                    </Button>
                  </div>
                  <hr />
                    ...
                    <Link to="/login">
                      <Button className="col-md-6">
                        <div className="row">
                          ...
                          <div className="col-md-10">Log In My Account</div>
                        </div>
                      </Button>
                    </Link>
                  </div>
