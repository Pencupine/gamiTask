          ...
          <div className="container">
            <div className="row">
              <div className="col-md-12 text-center">
                ...
                <h5 className="bp3-text-light">v1.1.1</h5>
                <p className="">
                  {" "}
                ...
                >
                  <Button intent={"primary"} onClick={this.handleOpenLogin}>
            ...
            >
              <div className="text-center auto">
                ...
                <div className="row">
                  ...
                  <Button className="col-md-8" style={{ margin: "5px" }}>
                    <div className="row">
                      <div className="float-left col-md-2">
                        <img
                ...
                <hr />
                <div className="row">Don't have an Account?</div>-
                <div className="row">
                  <div className="col-md-2" />
                  <Button className="col-md-8" style={{ margin: "5px" }}>
